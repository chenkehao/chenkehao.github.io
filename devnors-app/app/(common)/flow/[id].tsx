...
export default function FlowDetailScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: COLORS.light.bgSecondary }}>
      <PageHeader title="流程详情" showBack />
      ...
      <View style={{ padding: 16 }}>
        ...
        <Card variant="elevated" style={{ marginBottom: 16 }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            <View>
              ...
              {flow.company && (
                <Text style={{ fontSize: 14, color: COLORS.light.muted, marginTop: 4 }}>
                  {flow.company}
                </Text>
              )}
            </View>
        ...
        <Card style={{ marginBottom: 16 }}>
          ...
          {flow.timeline && flow.timeline.length > 0 ? (
            flow.timeline.map((item, index) => (
              <View
                ...
                style={{
                  ...
                  borderLeftWidth: 2,
                  borderLeftColor: index === 0 ? COLORS.primary : COLORS.light.border,
                }}
              >
                <View
                  style={{
                    ...
                    height: 10,
                    borderRadius: 5,
                    backgroundColor: index === 0 ? COLORS.primary : COLORS.light.border,
                  }}
                />
            ...
            <Text style={{ color: COLORS.light.placeholder, textAlign: 'center' }}>暂无流程记录</Text>
          )}
        </Card>
